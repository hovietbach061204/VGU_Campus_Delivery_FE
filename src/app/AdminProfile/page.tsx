    ...
    if (isEditing) {
      ...
      try {
        ...
        await updateUserProfile(userId, token, {
          ...
          phoneNumber: '', // Admins may not have phone, pass empty string
        ...
        if (msg.includes('400') || /old password/i.test(msg)) {
          setError(
        ...
        >
          ...
          <div className="mt-6 flex flex-col gap-3 text-center">
            ...
            <Button
              ...
              className="w-full rounded-[33px] bg-[#204944] px-6 py-2 text-white hover:bg-[#1a3a33]"
              type="button"
            >
              Edit Menu
            </Button>
